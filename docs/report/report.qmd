...
::: {#fig-training-curves-CASH_OUT layout-ncol=2 layout-nrow=2}
...
::: {#fig-training-curves-TRANSFER layout-ncol=2 layout-nrow=2}
...
![Decision tree](../../experimentation/reproduce_oza_2018/output/figures/result_class_weight/result_TRANSFER_decision_tree.png){#fig-decision-tree}
...
::: {#fig-model-comparison-validation-set layout-ncol=2}

![TRANSFER](../../experimentation/reproduce_oza_2018/output/figures/result_model_comparison/model_comparison_TRANSFER_validation.png){#fig-metric-1}

![CASH OUT](../../experimentation/reproduce_oza_2018/output/figures/result_model_comparison/model_comparison_CASH_OUT_validation.png){#fig-metric-2}

Precision-Recall Curve for the TRANSFER and CASH OUT validation sets.
:::
